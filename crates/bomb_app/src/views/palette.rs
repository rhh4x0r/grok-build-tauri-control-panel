...
fn entries() -> Vec<Entry> {
    vec![
        ...
        Entry { label: "Update workspace from main", keywords: &["git", "update", "merge"], icon: Lucide::GitMerge, action: Box::new(SyncThread) },
        Entry { label: "Review / Ship workspace", keywords: &["git", "ship"], icon: Lucide::GitPullRequestArrow, action: Box::new(LandThread) },
